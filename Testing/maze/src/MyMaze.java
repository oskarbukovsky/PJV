...
public class MyMaze {
    ...
    private int endX, endY; // ending coordinates

    // initialize with x and y the same
    public MyMaze(int aDimension, int startX, int startY, int endX, int endY) {
        // Initialize
    ...
    private void generateMaze() {
        generateMaze(this.startX, this.startY);
    }
    ...
    public void solve() {
        ...
        this.solve(startX, startY, endX, endY);
    }
    ...
    public static void main(String[] args) {
        MyMaze maze = new MyMaze(20, 3, 4, 18, 17);
        maze.solve();
        maze.draw();
    }
}